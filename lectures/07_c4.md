...
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/SystemContext.png){height=550}


## notation

![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/SystemContext-key.png)
...
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Containers.png){height=550}


## notation

![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Containers-key.png)
...
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Components.png){height=550}


## notation

![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Components-key.png)
...
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Code.png){height=500}
...
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/SystemLandscape.png){width=750}


## dynamic diagram (collaboration style)

![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Dynamic-Collaboration.png)


## dynamic diagram (sequence)

![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Dynamic-Sequence.png)
...
:::::::::
::::::::: {.column width="60%"}
![from [c4model.com](https://c4model.com/) | CC-BY 4.0](figures/borrowed/c4/Deployment-Development.png)
:::::::::
::::::::::::


# smart home example -- system context

![](figures/smarthome/smarthome_c4_system_context_v2.drawio.svg)


## smart home example -- container

![](figures/smarthome/smarthome_c4_container_v2.drawio.svg)


## smart home example -- component (logger)

![](figures/smarthome/smarthome_c4_component_logger_v2.drawio.svg)


## smart home example -- component (frontend)

![](figures/smarthome/smarthome_c4_component_frontend_v2.drawio.svg)


## discussion

::: {.r-fit-text}
is it possible to use UML in a hierarchical manner as C4?
:::
...
- [Excalidraw](https://excalidraw.com/)
    - has a [plugin](https://libraries.excalidraw.com/?target=_excalidraw&referrer=https%3A%2F%2Fexcalidraw.com%2F&useHash=true&token=t3GmI-WyZ2DeAX5-2XyOl&theme=light&version=2&sort=default#dmitry-burnyshev-c4-architecture) for drawing C4
- [Google Drawings](https://docs.google.com/drawings)
    - it does not have a person shape though, but can be constucted from a circle and a rectange
- [draw.io](https://draw.io) 
    - has UML and C4 elements, but collaborative work is not so smooth
:::::::::
::::::::: {.column width="30%"}
...
<a href="mindmap/c4.html" data-preview-link>summary mindmap</a>
