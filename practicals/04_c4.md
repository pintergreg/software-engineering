...
- missing labels
    - on arrows, components, names, types, technology
- unconnected resources
    - missing arrows
- putting everything on a huge diagram
    - use hierarchies, that is what C4 is about
- conveyor belt syndrome
    - architecture is not a flowchart, use display connections, dependencies and not data/control flow
- too general message, lack of details

::: {.mt-2}
reading: [7 More Common Mistakes in Architecture Diagrams](https://www.ilograph.com/blog/posts/more-common-diagram-mistakes/) by Billy Pilger
:::
...
:::::::::
::::::::: {.column width="30%"}
![[open in Excalidraw](https://excalidraw.com/#json=kH-voL6DzLoegPm8Xbo1B,u7q5iblpWLBuf_jyvkn-Dg)](../lectures/figures/user_statistics/system_context.excalidraw.svg)
...
:::::::::::: {.columns}
::::::::: {.column width="35%"}
![](../lectures/figures/user_statistics/container.excalidraw.svg){height=375}

:::::::::
::::::::: {.column width="65%" .fragment}
![](../lectures/figures/user_statistics/container_server_client.excalidraw.svg){height=425}
:::::::::
::::::::::::
